"""
@author : ganesh bandaru
@email : thisisvganesh@gmail.com
...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- ganesh')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("ganesh bandaru", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("thisisvganesh@gmail.com", True, self.white)
